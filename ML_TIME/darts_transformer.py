...
signals = np.load("FPL_Datasets/ML_TIME/signals.npy", mmap_mode="r",)
signals_gts = np.load("FPL_Datasets/ML_TIME/signals_gts3.npy", mmap_mode="r")
X = []
y = []
...
np.save("FPL_Datasets/ML_TIME/darts_X.npy", X)
np.save("FPL_Datasets/ML_TIME/darts_y.npy", y)
del X, y, signals, signals_gts
gc.collect()

X = np.load("FPL_Datasets/ML_TIME/darts_X.npy", mmap_mode="r")
y = np.load("FPL_Datasets/ML_TIME/darts_y.npy", mmap_mode="r")
