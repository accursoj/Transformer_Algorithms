...
np.save("DiscoveryDay/X_reg.npy", X)
np.save("DiscoveryDay/y_reg.npy", y)


signals = np.load("DiscoveryDay/X_reg.npy")
signals_gts = np.load("DiscoveryDay/y_reg.npy")
print(signals.shape)
...
np.save("DiscoveryDay/X_norm.npy", X)
np.save("DiscoveryDay/y_norm.npy", y)
